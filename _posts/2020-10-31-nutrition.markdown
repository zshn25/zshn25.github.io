...
<!-- {% include image.html url="https://metrocosm.com/wp-content/uploads/2016/07/world-obesity-map.gif" description="<em> Fig. 1: Obesity is increasing worldwide at an alarming rate. [Source]( https://metrocosm.com/map-world-obesity/)</em>" %} -->

<!-- {:refdef: style="text-align: center;"}
![https://metrocosm.com/map-world-obesity/ -fullwidth](https://metrocosm.com/wp-content/uploads/2016/07/world-obesity-map.gif){:width="100%"}
*Fig. 1: Obesity is increasing worldwide at an alarming rate. [Source]( https://metrocosm.com/map-world-obesity/)*
{:refdef} -->
